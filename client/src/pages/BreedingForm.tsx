        ...
        <CardContent>
          <Stack spacing={2}>
            ...
            <TextField label="現在の段階" select value={form.breedingStatus} onChange={(e) => setValue('breedingStatus', e.target.value)} fullWidth>
              ...
              <MenuItem value="発情確認">発情確認</MenuItem>
              <MenuItem value="種付予定">種付予定</MenuItem>
              <MenuItem value="種付実施">種付実施</MenuItem>
              <MenuItem value="移植予定">移植予定</MenuItem>
              <MenuItem value="移植実施">移植実施</MenuItem>
              <MenuItem value="中止">中止</MenuItem>
            </TextField>
            ...
            {form.breedingMethod === '受精卵移植' && (
              <>
                ...
                {form.breedingStatus === '中止' && (
                  <TextField
                    label="移植中止理由"
                    value={form.transferCancelReason}
                    onChange={(e) => setValue('transferCancelReason', e.target.value)}
                    placeholder="発情状態、黄体状態、体調、獣医師判断など"
                    required
                    fullWidth
                  />
                )}
