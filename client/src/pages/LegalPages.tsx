...
export function TermsPage() {
  return (
    <Stack spacing={2}>
      ...
      <LegalSection title="第4条（プランと料金）"><P>Freeは繁殖雌牛10頭まで無料で利用できます。</P><P>Standardは繁殖雌牛11〜50頭を対象とし、月額2,750円（税込・税抜2,500円）です。</P><P>Proは繁殖雌牛51頭以上を対象とし、月額5,500円（税込・税抜5,000円）です。</P><P>各プランの機能、料金その他の条件は、申込時に表示される内容が優先します。</P></LegalSection>
      ...
      <LegalSection title="第6条（契約期間・更新・解約）"><P>有料プランの契約期間は1か月です。</P><P>クレジットカード払いでは毎月自動更新され、解約されるまで継続します。各更新時に選択中のプラン料金が自動的に請求されます。</P><P>銀行振込では自動決済による更新は行いません。継続利用する場合は、運営者から次回分の支払いについて案内します。</P><P>利用者は、次回更新日前までに運営者へ解約を申し出ることができます。解約後も、支払済みの利用期間の末日までは利用できます。</P><P>法令上返金が必要な場合を除き、利用期間途中の解約による日割り返金は行いません。</P></LegalSection>
...
export function CommercePage() {
  return (
    <Stack spacing={2}>
      ...
      <LegalSection title="販売価格・役務の対価"><P>Free：0円</P><P>Standard：月額2,750円（税込・税抜2,500円）</P><P>Pro：月額5,500円（税込・税抜5,000円）</P></LegalSection>
      ...
      <LegalSection title="支払時期"><P>クレジットカード：申込時に初回料金を決済し、その後は毎月の自動更新時に決済します。</P><P>銀行振込：運営者が申込受付後に案内する支払期限までにお振り込みください。</P></LegalSection>
      ...
      <LegalSection title="契約期間・自動更新"><P>有料プランの契約期間は1か月です。</P><P>クレジットカード払いは毎月自動更新され、解約されるまで継続します。銀行振込は自動決済による更新を行いません。</P></LegalSection>
