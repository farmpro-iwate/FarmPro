...
export function TermsPage() {
  return (
    <Stack spacing={2}>
      ...
      <LegalSection title="第4条（プランと料金）"><P>Freeは繁殖雌牛10頭まで無料で利用できます。</P><P>クレジットカード払いの場合、Standardは繁殖雌牛11〜50頭を対象とし月額2,750円（税込・税抜2,500円）、Proは繁殖雌牛51頭以上を対象とし月額5,500円（税込・税抜5,000円）です。</P><P>銀行振込の場合、Standardは年額33,000円（税込・税抜30,000円）、Proは年額66,000円（税込・税抜60,000円）です。</P><P>各プランの機能、料金その他の条件は、申込時に表示される内容が優先します。</P></LegalSection>
      <LegalSection title="第5条（支払い）"><P>有料プランの支払方法は、クレジットカードまたは銀行振込です。</P><P>クレジットカード決済はStripeを利用して処理します。カード番号等の決済情報はStripeの決済画面で入力され、FarmProではカード番号を保存しません。</P><P>銀行振込は1年分の料金を一括で支払う年払いです。申込受付後、運営者から振込先と支払期限をご案内します。振込手数料その他利用者側で発生する費用は利用者の負担とします。</P></LegalSection>
      <LegalSection title="第6条（契約期間・更新・解約）"><P>クレジットカード払いの契約期間は1か月、銀行振込の契約期間は入金確認による有効化から1年間です。</P><P>クレジットカード払いでは毎月自動更新され、解約されるまで継続します。各更新時に選択中のプラン料金が自動的に請求されます。</P><P>銀行振込では自動更新または自動決済は行いません。継続利用する場合は、契約期間満了前に運営者から次年度分の支払いについて案内します。</P><P>利用者は、次回更新日前または次年度契約開始前までに運営者へ解約を申し出ることができます。解約後も、支払済みの利用期間の末日までは利用できます。</P><P>法令上返金が必要な場合を除き、利用期間途中の解約による日割り返金は行いません。</P></LegalSection>
...
export function CommercePage() {
  return (
    <Stack spacing={2}>
      ...
      <LegalSection title="販売価格・役務の対価"><P>Free：0円</P><P>Standard：クレジットカード月額2,750円（税込・税抜2,500円）／銀行振込年額33,000円（税込・税抜30,000円）</P><P>Pro：クレジットカード月額5,500円（税込・税抜5,000円）／銀行振込年額66,000円（税込・税抜60,000円）</P></LegalSection>
      <LegalSection title="商品代金以外の必要料金"><P>インターネット接続に必要な通信料は利用者の負担です。銀行振込を選択した場合の振込手数料は利用者の負担です。</P></LegalSection>
      <LegalSection title="支払方法"><P>クレジットカードまたは銀行振込。</P><P>クレジットカード決済はStripeの決済画面を利用します。銀行振込は1年分一括払いで、申込受付後に運営者から振込先をご案内します。</P></LegalSection>
      <LegalSection title="支払時期"><P>クレジットカード：申込時に初回料金を決済し、その後は毎月の自動更新時に決済します。</P><P>銀行振込：1年分の料金を、運営者が申込受付後に案内する支払期限までにお振り込みください。</P></LegalSection>
      ...
      <LegalSection title="契約期間・自動更新"><P>クレジットカード払いの契約期間は1か月で、毎月自動更新され、解約されるまで継続します。</P><P>銀行振込の契約期間は入金確認による有効化から1年間で、自動更新または自動決済は行いません。継続利用する場合は次年度分の銀行振込が必要です。</P></LegalSection>
      <LegalSection title="解約・キャンセル・返金"><P>クレジットカード払いは次回更新日前まで、銀行振込は次年度契約開始前までに運営者へ解約を申し出ることで、次回の契約更新を停止できます。解約後も支払済みの利用期間の末日までは利用できます。</P><P>デジタルサービスの性質上、サービス提供開始後の利用期間途中のキャンセルおよび日割り返金は原則として行いません。ただし、法令上返金が必要な場合、または運営者の責に帰すべき事情がある場合はこの限りではありません。</P></LegalSection>
