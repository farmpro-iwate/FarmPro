...
const candidateSchema = {
  ...
  properties: {
    activityType: {
      type: 'string',
      enum: ['', '発情', '種付', '受精卵移植', '妊娠鑑定', '分娩', '治療', 'ワクチン', '哺育・離乳', '飼料給与', '出荷・販売', 'その他'],
    },
          ...
          content: [
            {
              ...
              text: [
                ...
                `今日の日付は ${today} です。`,
                'activityTypeは内容に最も近いものを1つだけ選んでください。発情、種付、受精卵移植、妊娠鑑定、分娩、治療、ワクチン、哺育・離乳、飼料給与、出荷・販売のいずれにも当てはまらなければその他、判断できなければ空文字にしてください。',
                ...
                'detailsには、症状、薬剤、授精方法、種雄牛、鑑定結果、分娩結果、ワクチン名、哺育・離乳内容、給与内容、出荷先、販売先、販売額など、発話に含まれる具体情報だけを並べてください。',
