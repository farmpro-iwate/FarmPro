          ...
          {loading ? <Typography>読み込み中...</Typography> : (
            <Table size="small">
              ...
              <TableBody>
                {cattle.map((cow) => (
                  <TableRow key={cow.id}>
                    <TableCell>{cow.earTag}</TableCell>
                    <TableCell>{cow.name}</TableCell>
                    <TableCell>{cow.birthday}</TableCell>
                    <TableCell>{cow.parity}産</TableCell>
                    ...
                    <TableCell align="right">
                      <IconButton component={RouterLink} to={`/cattle/${cow.id}/edit`} aria-label="編集"><EditIcon /></IconButton>
                      <IconButton color="error" onClick={() => handleDelete(cow)} aria-label="削除"><DeleteIcon /></IconButton>
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
